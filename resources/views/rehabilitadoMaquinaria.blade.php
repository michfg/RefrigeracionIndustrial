...
@section('content')
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item" aria-current="page">Rehabilitado de maquinaria</li>
  </ol>
	<div class="container">
		<div class="section" >
		...
		<div class="col-md-9" align="center" id="descripcionServicio">
			<div class="card wow bounceInLeft">
			  <div class="card-header">
			    <h1>Rehabilitado de maquinaria</h1>
			  </div>
			  <div class="card-body">
			    
			     <h4>Precio: $2000 </h4>
                         <h4>Descripción:</h4>
                         <p>Contamos con la experiencia necesaria para identificar plenamente todos los componentes de su maquinaria y equipos seminuevos , y así poder repararlos, actualizarlos o bien sustituirlos con el fin de obtener una operación eficiente de sus sistemas.</p>
